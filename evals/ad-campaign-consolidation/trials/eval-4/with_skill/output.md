...
- **Per-branch conversion volume on the _purchase_ event**, over a lag-mature window — this is what the whole plan hinges on and it's absent.
...
2. **Do the optimisation-event switch now, not next weekend.** If purchase volume looks viable, flipping ATC→purchase on the 3 keepers _this week_ gives them a week-plus of relearning before Black Friday instead of days. If volume looks thin, don't flip it at all until after Black Friday — let ATC carry the peak and revisit post-BF.
