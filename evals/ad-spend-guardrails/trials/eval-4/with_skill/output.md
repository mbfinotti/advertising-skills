...
Because you asked for something to operate on today rather than nothing, this policy is built to be safe under uncertainty: it binds on the _worse-case_ end of your margin guess, and it prices in a buffer for the fact that the guess could still be wrong. Treat it as a placeholder to tighten, not a benchmark to defend.
...
- **Owner of break-even and hard floor:** _[name needed — not filled in, because inventing one would defeat the point of separating who spends from who sets the ceiling]_
- **Owner of target floor / weekly review:** _[name needed]_
