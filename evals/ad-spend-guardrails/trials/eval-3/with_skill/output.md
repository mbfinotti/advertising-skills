...
| Whether MER is platform-reported or business-validated | Missing — critical. A platform-reported MER measures _claimed_ revenue, not _caused_ revenue, and rewards shifting spend into retargeting/branded search. If Torvale doesn't have an incrementality read (geo holdout, MMM, or at minimum a UTM-validated revenue feed), the guardrail below is measuring the wrong thing. |
