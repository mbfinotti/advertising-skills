...
- **No standard Lookalike Audiences.** Meta disabled 1%-style Lookalikes for Special Ad Category campaigns; you get **Special Ad Audiences** instead — a lookalike-style tool deliberately built to *not* weight on signals correlated with protected classes.
