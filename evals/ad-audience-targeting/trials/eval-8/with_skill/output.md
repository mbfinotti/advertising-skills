...
| 45 chains that raised money / got acquired | 4-6 months | ⚠️ **Stale as a signal, still valid as an attribute.** Past ~90 days it no longer tells you who to reach *first* — it tells you who can *afford to buy*. Use it to qualify, not to prioritize. Don't message these 45 as "we saw your raise"; that window closed. |
