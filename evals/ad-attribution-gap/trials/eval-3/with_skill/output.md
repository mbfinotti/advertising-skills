...
- **38% of Q2 leads** have a click ID on file — a *lead-level*, Q2-cohort stat.
- **4 of 23 deals** were claimed by LinkedIn — a *deal-level* stat for deals that *closed* in Q2 (their leads may have been created months earlier, given a ~$40k ACV deal typically runs a multi-month cycle).
