...
## Don't present it as reconciled. Present it as reconciled _to 66%_, and say so on the slide.
...
- **"Most complete data" ≠ "most accurate data."** Google sees more _of the internet_, but your order system sees more _of your actual revenue_ — it's the one system tied to money that actually landed in the bank. Completeness and accuracy are different axes; the CMO is conflating them.
...
Then one line: _"Remaining gap being investigated; likely candidates are [your best hypotheses — e.g. cross-device attribution, ad blockers/consent-mode data loss, coupon/affiliate double-count, direct-to-Google-Ads misattribution of organic]. Update at next board meeting."_
