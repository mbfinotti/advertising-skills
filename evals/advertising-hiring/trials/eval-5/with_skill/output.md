...
**Media buyer / PPC specialist rung**, channel = paid search (Google Ads + Microsoft Ads), scoped to own a portfolio of client accounts on the bench.
...
4. Client communication (defending results, explaining attribution under pushback)
5. Pod collaboration (agency-specific — plugging into an existing team without a solo mandate)

## Requirements

**Must-haves (5):** hands-on Google Ads platform ownership (not just oversight of a junior), a killed-campaign story with a reason attached, comfortable being audited live on a real account, can explain MER vs. ROAS without prompting, worked inside a shared account/reporting structure before (agency or in-house team, not solo freelance only).

**Nice-to-haves:** Microsoft Ads experience, B2B lead-gen experience (bench likely serves mixed segments), prior agency pod experience specifically.
...
Source: Duane Brown / Take Some Risk PPC salary survey, 2026 edition (445 responses), reported in Search Engine Land, April 13, 2026. US medians by experience: 3–5 yrs $87,500; 6–9 yrs $100,000; 10–15 yrs $135,000. **Agency specifically under-earns in-house at every band** (10–15 yrs: $123,545 agency vs. $140,000 in-house) — budget the bench accordingly rather than benchmarking against in-house postings. UK 3Search 2025 guide: PPC managers £50,000–£70,000. Every figure is self-selected-survey directional, not a floor or ceiling.
...
Every question maps to exactly one competency. No "best practices" answer scores above a 2 on any anchor — reasoning rooted in context and a test-and-learn approach is what separates a 4 from a 2.

## Scorecard and the anti-polish rule

This is the direct fix for your stated problem, so it's non-negotiable, not a suggestion:
...
**Certifications** (Google Ads, Microsoft Ads): score them nowhere in competence. If Halyard needs a minimum % of certified staff for Google Partner status, say that explicitly in the req as a compliance requirement — separate from whether the candidate can do the job — not as a hidden skill bar.

## Work sample

**Format: live screen-share account audit**, inside round 2, on a sanitized Halyard account copy (never a live client account, never take-home). Highest signal per candidate-hour available to you, and it defeats AI-generated or templated "audit" output the way a take-home can't.

- Paired diagnostic prompt: "A month into this campaign, what results would raise a red flag?" — score for a specific number (e.g., ROAS below 2:1), not a vague answer.
- Build in deliberate ambiguity: the accompanying data table should be genuinely inconclusive on at least one question you ask. A candidate who confidently answers an underpowered question is showing you the exact failure mode the job will punish; naming the ambiguity is a top-tier answer, not a dodge.
- Rubric is written before the first candidate sits it.
- Debrief the reasoning aloud — that carries more signal than the artifact itself; budget time for it inside the 90 minutes rather than treating the audit as a pass/fail checkbox.

**What's deleted, and why:** the unpaid multi-hour take-home is off the menu entirely — it's the one format whose funnel cost (senior people decline it outright) exceeds its signal, and it's very plausibly part of why candidates are dropping out mid-process now. The paid trial is also deleted for this req — nothing in your brief suggests Halyard has budget/approval for paid pre-hire work, and two bench seats don't obviously warrant setting that up; promote it later only if a specific candidate is already contracting elsewhere and a week of their time becomes cheap to buy.

## Ramp — two hires, run separately, access identical

**Day one, both hires:** every relevant client ad account, the web-analytics property, the tag manager, the commerce/CRM backend where applicable, the BI/reporting layer. Not "on request" — delayed access is a documented, avoidable cause of a slow start.
...
- By day 90: full authority on an account, **contingent on that account's measurement audit passing** — no audit, no full authority, account by account, not a single org-wide gate.

First win targeted for both hires: a tracking/reconciliation fix, never a scaling bet — this also happens to double as the day-30 outcome above.

**Watch areas** (distinct from goals): retreating into platform UI instead of finishing the measurement audit; creative briefs stalling because no one owns the designer relationship on that account; either hire quietly re-running DTC-style optimization on a long-cycle B2B client account (or the reverse) without flagging it.

**Channel-verdict patience:** don't let anyone — including the new hires — conclude a channel isn't working before 3–6 months on an account; and don't promise a day-30 milestone that requires a statistically resolved test, the platform's own learning phase won't allow it.

## Turnover, honestly

Quote as a range, not a single number: 18–45% depending on source and cohort (UK agency staff turnover 26.8%, IPA 2021; sampled-agency average 18–20%, Campaign US 2025; industry-wide ~30%, ANA/Adweek). If either of these two hires leaves inside 45–90 days, the evidence points at your access/threshold rollout, not the candidate — check the ramp before re-running the loop.

---

Two hires, same packet, scored and ramped independently — don't compare them against each other, compare each against the anchors.