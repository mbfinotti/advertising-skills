# Gate check first — this fails before any packet gets built
...
Ranked by coverage bought per hour of your own time, then narrowed to what a 4-person, $3,500/month shop can actually absorb:

- **Agency — deleted.** A competent B2B LinkedIn agency retainer typically runs $2,500-$5,000/month on top of ad spend. That alone exceeds your entire channel budget. Off the table on cost, not on merit.
- **Freelancer — the realistic bridge, but not yet.** Lower cost, reversible in a notice period, no worker-classification exposure if structured as a short defined-scope contract. Worth revisiting once positioning is stable, for a light, few-hours-a-week engagement to keep the account warm — not to chase pipeline.
- **Self-manage — the honest answer for the next 4-8 weeks.** You already have deep technical/data judgment; run this yourself or have a co-founder own it at minimal spend (or paused entirely) while positioning settles. Full control, no new commitment to unwind.
- **Wait — the actual recommendation.** Pause new LinkedIn spend, or hold it at a token level with no performance expectation, until the homepage rewrite ships and pricing holds for at least one full quarter.
...
4. Budget covers real testing volume — either LinkedIn spend moves up, or you accept a longer timeline to reach significance at $3,500/month.

At that point the scorecard/interview loop/work sample is a fast build — the role is a straightforward first-hire call (performance marketer, generalist, owns measurement + one channel), and I can turn it around in one pass once the above is true. I'd rather hand you that packet when it can actually produce a hire who survives past month two than hand it to you now and watch the 6-week clock make the call for you.
