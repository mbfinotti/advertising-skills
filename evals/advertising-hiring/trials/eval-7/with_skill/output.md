## Verdict: your VP is right to worry, your CMO is right that talent isn't disqualifying — but "reject" and "great media buying transfers" are both the wrong call. This is a probe-and-weight case, not a coin flip between two VPs.

**The sourced evidence backs the VP's instinct, not the CMO's claim.** Constant Hire, a DTC recruiter, states it flatly: "A buyer who has run paid search and lead generation for a SaaS company optimizes toward pipeline, not first-order profitability. Those instincts do not transfer well." The mirror source (The Remote Reps) confirms the reverse direction too. This isn't a vague culture-fit worry — it's a named, documented failure mode: **DTC buyer optimizing to first-order profitability on a long sales cycle**, sitting right next to its twin (B2B buyer slow on creative iteration, weak on margin discipline).
...
## What to run in the final round
...
**3. Adapt the senior ROAS-drop filter to the B2B version of the same diagnostic tree** (measurement → media → creative → post-click), but make her translate the output: instead of MER/break-even, have her state what she'd report as the business-level number here (pipeline-influenced revenue over spend, not platform ROAS). This is the same filter, re-aimed — it tells you whether her rigor transfers even if her vocabulary doesn't.

**4. Work sample: a live screen-share audit or data-table case, not a take-home.** Build it from an anonymized B2B dataset with deliberate ambiguity baked in — e.g., strong platform ROAS but flat pipeline, confounded by the 6-month lag. A DTC-trained candidate who confidently resolves this without flagging the lag as insufficient information is showing you the exact failure mode your VP is worried about. A candidate who says "I can't conclude this yet, the sales cycle means this cohort hasn't had time to convert" is showing you the opposite — score naming that ambiguity as a top answer, not a hedge.

**5. Score independently, then debrief where the VP and CMO disagree — not before.** Each of you submits scores with cited evidence before comparing notes. If your VP's "reject" and your CMO's "take" turn out to rest on different competencies (VP grading the instincts-transfer probe, CMO grading raw media-buying craft), that's useful — it tells you which one of them is actually seeing a gap versus a strength, instead of two gut calls talking past each other.
