...
## 1. Does hand-optimisation have three years left?
...
Don't rank B2B against DTC — they're not competing options, they're two markets that use the same underlying skill set on different channel mixes. Where you'll actually be tested is narrower than it feels:

**Transfers unchanged:** platform mechanics, bidding logic, tracking/attribution setup, budget pacing, audience construction, testing discipline, unit-economics literacy, diagnostic mindset. Seven years of that is real, portable depth.

**The one real gap moving to DTC:** creative cadence. B2B runs low creative volume with account-based personalisation; DTC runs constant creative testing. That's it — not the metrics (you already think in CAC, CPA; DTC just adds ROAS/MER/contribution margin, which is vocabulary, not new judgment), not the mechanics, not the platforms.

**So the "found out" fear is mistargeted.** You're not underqualified for the discipline — you're short one specific, buildable habit. Close it before the conversation goes further:

- Cheapest, zero-compliance-risk proof: run a public written teardown of two or three DTC cookware/home-goods ad accounts, applying a weekly creative-testing cadence to your recommendations. An hour, public ads, no NDA exposure, and it doubles as live-audit rehearsal if this becomes a formal interview.
- If you have a spare evening budget over the next month: put a small amount of your own spend behind a catalogue/feed campaign for anything self-funded. It's the most credible no-experience proof and it's the DTC-specific rep you're missing.
- Don't lean on certifications to close this gap — they're table stakes with near-zero standalone signal; one published teardown outranks the whole menu.

**But "Head of Performance" is the bigger question than B2B vs DTC.** That's a lead-rung title: P&L ownership, cross-channel allocation, hiring, at least one completed incrementality test. Two observable thresholds decide whether you're actually ready for that title anywhere, not just at this brand:

- Do you currently hold budget or forecast responsibility in your B2B role — not just execution?
- Have you ever run a geo holdout or conversion-lift test?

If both are yes, the recruiter conversation is a lateral-seniority move with a channel-mix change, and your impostor read is wrong. If either is no, the DTC brand is asking you to grow into the title on the job — worth naming to yourself and to them, not hiding. Either way, walk in with a one-pager built the same way an internal promotion case is built: what you own now, what the owned number did (indexed — B2B software client data stays anonymised regardless of the audience), and how it maps to what "Head of" is actually screened for. That's a stronger answer to "why should we trust you" than any amount of DTC trivia, and it's evidence instead of a feeling — which is the actual fix for "scared I'd be found out."

## The combined 1–3 year plan

1. **Next 4–6 weeks (deadline: the recruiter conversation):** publish one anonymised DTC ad-account teardown with a creative-testing point of view; draft the one-page case for "Head of Performance" naming your owned budget/forecast scope and, if you have one, your incrementality test. Signal it's done: teardown published, one-pager exists.
2. **This quarter (compounding):** if you don't already hold budget/forecast responsibility in your current seat, ask for it explicitly. Signal: responsibility formally granted, or a named date it won't be.
3. **Next 2 quarters:** run your first incrementality test (geo holdout or conversion lift) if you haven't — this is the clearest lead-track signal there is, and it's channel-agnostic, so it strengthens both the DTC option and staying in B2B.
...
Deleted from your menu, by name: a UK Level 3 apprenticeship and freelance-first — neither applies to a 7-year practitioner evaluating a lead-level move, so don't let either surface later as a default you drifted into.