## Short answer: don't anchor at £75,000 — that figure is stale, and stale in the wrong direction
...
"Senior marketing manager" is a broad, generic title. You're a **senior paid media manager** — closer to the "Senior Strategist/Director" rung (screened for multi-account budget/forecast ownership and C-level narrative, not generalist marketing management). The more relevant figure:

- **Survey**: 3Search Performance Marketing Salary Guide 2025 (1,300+ respondents) — PPC/paid media managers: **£50,000–£70,000**.
- **Aggregate, directional only**: Major Players (2026) — Director-level up to ~£85,536 (wide range, not a point figure).

I have no Manchester-specific (vs. London-weighted) breakdown for either source — that's a real data gap, not something to paper over with a guessed regional discount.
...
Don't lead with a point figure at all. Anchor to a range, tie it to scope, and make the number contingent on what the retail brand is actually handing you:

> "Based on current market data for senior paid-media roles — I've been tracking the Marketing Week and performance-marketing salary surveys — I'm expecting somewhere in the **£62,000–£70,000** range, depending on the scope of budget and forecast ownership that comes with this seat. I'd want to understand more about the retail media spend I'd be accountable for before landing on an exact number — and I'd want to talk total package, not just base, if there's a bonus or revenue-share component."
...
## One more thing to check before the final round

If you have any budget/forecast ownership at your current role, or you've run anything resembling an incrementality test (geo holdout, conversion lift), lead with that as the reason you're pricing at the top of the range rather than the middle — a promotion-style case built on an owned number beats one built on a survey average every time.
