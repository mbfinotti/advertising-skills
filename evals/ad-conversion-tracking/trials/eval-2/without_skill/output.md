...
You already found the root cause. Meta deduplicates a Pixel event and a CAPI event as _the same conversion_ only when **both** of these match exactly between the two events:
