...
- (f) is structurally upstream of everything: fixing (a)/(b)/(d) is unverifiable in Google Ads reporting until gclid actually reaches the page. Start it earliest despite listing it 3rd, because it has the longest lead time (dev-dependent) — sequence by _when you start_, not just _when it lands_.
