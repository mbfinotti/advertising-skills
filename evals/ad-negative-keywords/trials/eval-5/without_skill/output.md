...
**Bottom line:** you're not missing $7k of "junk" — you're missing an entire *channel type's* worth of visibility. The 9k you can see is Search; the other 7k is very likely PMax/Shopping (opaque by design) plus normal privacy suppression.

## Step 1 — confirm this diagnosis instead of guessing

Pull cost by campaign *type* and compare it against `search_term_view` cost per campaign, via the Ads API. This nails down exactly which channel is eating the 7k, in minutes:
