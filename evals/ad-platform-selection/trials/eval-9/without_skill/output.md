# When to expect results from the TikTok/Reels push

**Short answer: probably never, at this creative velocity — and if it does work, not before 10-12 weeks.** The budget isn't the binding constraint. Creative supply is.

## The mismatch

- TikTok and Reels are native-video, high-frequency-refresh platforms. Ad fatigue on small accounts sets in within **5-10 days** per creative — the algorithm needs new material constantly or CPMs climb and CTR collapses.
- You're producing **2 static graphics/month**. That's roughly 1 creative every 15 days, and it's the wrong format — static images are a second-class citizen on TikTok specifically, with weaker CTR/CVR than native video.
- Result: you'll exhaust your creative pool in the first 1-2 weeks, then spend the rest of the month serving stale ads into a fatigue-prone algorithm.

## Budget vs. algorithm learning phase

- $7K split 2 ways = $3.5K/platform. Meta and TikTok both want ~50 conversions per ad set/week to exit learning phase and stabilize CPA.
- At $190/month with a B2B eval cycle (trial → paid, not impulse buy), you likely won't hit that conversion volume per ad set on $3.5K. Expect **volatile, unreliable CPA for at least 4-6 weeks**, possibly longer since you're relearning every time a stale creative gets swapped.

## Realistic timeline if you proceed as-is
