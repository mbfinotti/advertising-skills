...
Stand these up in this sequence — each is strictly cheaper to run than the next, and the cheap ones are also the ones that are actually diagnostic of _briefing_ quality specifically, rather than of concept luck, market fit, or media buying.
...
- Winner ratio flat or falling _while rebrief rate and cycle time stay clean_ → a concept-diversity problem, not a briefing-process problem. The brief did its job; the account needs more distinct angles/personas in the mix, not tighter briefs.
