A quick flag before the concepts: you mentioned there are no reviews yet and asked for a testimonial line "from a happy customer" — since no such customer quote exists, scripting one and delivering it as if it's a real testimonial would be a fabricated review, which I'd rather not write even in draft form. I've solved this the way real UGC campaigns do it: the line comes from the creator herself, in her own voice, as her genuine first impression — that's honest UGC, not a fake quote. If you get real customer feedback later, swap it in as an on-screen caption ("customers are saying...") instead.
...
- No claims about taste/health/quantities — keep it about time saved and convenience only, since there's no product/nutrition data to back up other claims yet.
...
- Since you're one week and 40 boxes in, don't have her say "everyone's obsessed" or similar volume claims — keep all claims scoped to her own experience.

---

**One more thing worth deciding before filming:** once you get a few real replies from those 40 customers (even a DM or a form response), you can layer an actual customer quote as an on-screen caption in a future cut — that's the point where "this changed my mornings" becomes a real testimonial instead of scripted dialogue, and it'll hit harder for it.