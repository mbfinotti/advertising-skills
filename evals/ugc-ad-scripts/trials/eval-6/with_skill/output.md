...
## Concept 1 — Free Trial · "Quiet Confession"

**Concept**: Freelancers with irregular income · motivation: money-shame relief ("I stopped being scared to open my bank app") · format: solo creator, no music, close-up, low energy · offer: free trial. Duration 20s. **Validation: grounded.**

**Visual style**: Intimate, vulnerable, natural light, phone in hand, minimal cuts — feels like a confession, not an ad.
...
- A: "Try Quillbird free — one real month, no guessing."
- B: "Start your free trial. See your next real month."

**End-card** (17–20s, silent, on-screen text, identical on all 4 concepts — see shared block below)

**Delivery notes**: Tone — venting to a friend, not performing. Setting — couch/bed, real clutter fine. No presenter energy, no smiling through the hard beat. Do: let the confession land flat before the tone lifts at the solve beat. Don't: play the fear beat for laughs. `[CONFIRM: trial length — not specified, do not say a number of days on camera until confirmed]`.

---

## Concept 2 — Code QUILL20 · "Chaos-to-Calm Meme Edit"

**Concept**: Same audience · motivation: order from chaos ("it made my chaos months make sense") · format: fast jump-cut, meme-caption energy · offer: QUILL20 discount code. Duration 20s. **Validation: grounded.**

**Visual style**: Fast cuts, bold captions, messy-desk B-roll cutting to clean app UI, upbeat pace.
...
- A: "Download Quillbird and use code QUILL20 at checkout."
- B: "Grab Quillbird with code QUILL20 — your discount's ready."

**End-card** (17–20s): shared block below.

**Delivery notes**: Cut every 2 seconds, no wasted frame. Music/trending audio fine here (only concept where it fits the tone). Do: keep captions punchy, 3–7 words. Don't: let the joke undercut the actual value line — it still has to land as real. `[CONFIRM: QUILL20's actual value — % off or flat amount — not specified, do not state a figure on camera until confirmed]`.

---

## Concept 3 — Waitlist · "Sneak Peek / Insider"

**Concept**: Same audience · motivation: feeling understood ("first budget that gets that my income is spiky"), pivoted into anticipation · format: teaser, blurred screen, whisper tone · offer: waitlist for a new feature. Duration 20s. **Validation: grounded on the quote; the feature itself is UNVALIDATED — no name or description was supplied, placeholder used.**

**Visual style**: Documentary/behind-the-scenes lighting, phone tilted away or partially blurred, insider-secret tone.
...
- A: "Get on the waitlist — be first when it's live."
- B: "Join the waitlist. We'll tell you the second it drops."

**End-card** (17–20s): shared block below.

**Delivery notes**: Whisper/insider register, not hype-voice. Hold the phone at an angle that reads as "accidentally revealing" rather than staged. Do: keep the actual feature completely unnamed. Don't: promise a specific date or capability you can't confirm. `[CONFIRM: feature name/description before filming — nothing was supplied, teaser is written to work without it, but the creator needs a real one-line description off-camera so the tease doesn't sound empty]`.

---

## Concept 4 — Direct Download · "Straight-Up Pitch"

**Concept**: Same audience · motivation: reused (money-shame relief quote, reframed for confidence) · format: bright, direct-to-camera, no gimmick · offer: download, no incentive attached. Duration 20s. **Validation: grounded.**

**Visual style**: High energy, bold on-screen numbers/text, walking-and-talking or standing set, fastest pacing of the four.
...
- A: "Download Quillbird — build a budget for however this month looks."
- B: "Get Quillbird today. Stop budgeting for a paycheck you don't have."

**End-card** (17–20s): shared block below.

**Delivery notes**: Fastest pace of the four, no pauses. Do: keep it standing/walking, energetic, minimal props. Don't: let this one turn into a features list — one value prop, said with conviction, beats three said flat.

---

## Shared end-card (all 4 concepts, 17–20s, identical, on-screen text only, no spoken line)

> **Download Quillbird · Follow for more freelance money tips · Code QUILL20 — live all month**

Silent by design — this is the beat where your compound ask lives, so it doesn't compete with the spoken, single-ask CTA above it. Visual: creator does a simple closing beat (holds phone up, nods, small smile) under the text; no new dialogue.
...
6. **Unconfirmed claims — do not film until resolved**: trial length, QUILL20's actual discount value, and the new feature's name/description are all placeholders. None were invented; all three need your confirmation before a number or feature detail is said on camera, since a wrong or unsubstantiated figure is a compliance problem here, not just an editing one.
7. **Typicality**: the three quotes describe emotional relief, not a quantified financial outcome, so no "results not typical" line is strictly triggered — but re-check this once real screen-recorded numbers get added in a later round (see deleted archetypes above).

## Humanizer pass

No general-purpose English marketing humanizer skill was available in this environment (the two loaded humanizer skills are French-language and STE100 technical-manual specific — neither fits UGC ad copy). Lines above were hand-written for spoken, unpolished delivery instead — short, contraction-heavy, no brand adjectives ("revolutionary," "seamless," etc. don't appear anywhere). Re-run a proper humanizer pass if one becomes available before locking final lines.

## Measurement plan

- **What each package tests**: 3 hook variants against one fixed body, fixed offer, and one fixed spoken CTA — the standard single-variable read.
- **What the 4-package round does NOT test cleanly**: concept and offer move together across the four (see the strategy flag at the top). Read this round as "which of four value props gets a second look," not as an isolated hook, concept, or offer test.
- **Baseline**: pull Quillbird's own trailing median hook rate (3s plays ÷ impressions) and hold rate (15s ÷ 3s plays) for comparable vertical-feed placements. A new hook passes when it beats that median — don't chase a published "good" benchmark; those range 18–40% across vendors for the same metric and aren't comparable.
- **Diagnose in order, fix only the failing stage**: low hook rate → rewrite hooks. Healthy hook rate, low hold rate → fix the hook→body transition or the body. Healthy hold, low CTR → the spoken CTA is unclear. Healthy CTR, low conversion → it's the offer or landing page, not the script.
- **Next round**: promote proof-first or silent review once you have cleared screen-recording footage or a documented number; separate concept from offer as two variables once one of these four value props is a clear leader.
