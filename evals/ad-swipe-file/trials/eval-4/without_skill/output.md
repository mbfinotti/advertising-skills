## Short answer: No — not yet. The 1-in-21 result doesn't actually tell you the process is broken.
...
If most of the 20 are "inconclusive" rather than "lost," your bottleneck is test rigor, not hypothesis sourcing.

**On the podcast's 10-11% number**

Treat it as marketing, not a benchmark. "Best creative teams" is a survivorship-biased sample with unknown methodology (how do they define "clear winner"? What vertical, budget, and test duration?). Anchoring your process to an unverified anecdote from a podcast is itself a weaker decision input than your own 3 months of data — and your own data says "inconclusive," not "broken."

**Recommended next step instead of ramping sourcing:**

- Keep hypothesis volume roughly flat.
- Concentrate spend on fewer creatives tested longer/deeper (or extend test duration) so each test actually reaches significance.
- Re-tag last quarter's 20 non-winners as won/lost/inconclusive using a fixed statistical threshold, and see how many were truly losses.
- Revisit the "should we source more competitor ads" question only after you have 2-3 quarters of properly powered tests — that's roughly 60+ trials, which is closer to what you'd need to reliably tell 5% apart from 10%.