...
Whatever conversion event you're counting today (lead vs. booked job matters — which is it?), clicks from the Sept 3 budget change won't fully mature into booked jobs until ~Sept 24. Any verdict before then is judging an unfinished funnel. This is the strongest argument for _not_ making a big irreversible call today.
