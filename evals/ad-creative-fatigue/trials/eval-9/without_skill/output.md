...
- **Advantage+ learning reset.** Swapping 100% of creative at once forces the whole campaign back into learning phase simultaneously — CPA usually spikes _further_ for 1–2 weeks before it improves.
...
- **Frequency ceiling** (e.g., 2.5–3 depending on funnel length) as an early-warning trigger for the _next_ refresh, so you're not back here in another 3-week fatigue spiral.
