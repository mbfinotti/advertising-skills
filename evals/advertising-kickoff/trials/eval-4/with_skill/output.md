# Pinefield Robotics — Hiring Packet + Cousin's Roadmap
...
- Measurement trustworthiness: assumed **unknown/unvalidated**, since you've been running this yourself. This gates the ramp below.
- Horizon: board approval + "first performance marketing manager" reads as a compounding hire, not a one-off fix.
- Panel: assumed you personally sit on it, budget for a paid work-sample round is unconfirmed → defaulted to in-interview, unpaid, time-boxed formats.

---

## Part 1 — Hiring Packet: Pinefield Robotics, Performance Marketing Manager

```
HIRING PACKET — Pinefield Robotics, Performance Marketing Manager, 2026-09-12, v1
```
...
- **Mission**: Turn Pinefield's $70k/month, currently run ad hoc by the founder, into a measured, accountable program with a documented CAC/pipeline reality.
- **Ranked outcomes** (set real dates against your calendar):
  1. Measurement audit complete and platform-vs-backend (CRM/order system) reconciliation documented — by day 30.
  2. A written spend-approval threshold and channel ownership live — by day 30 (this should exist before day 30, not be day 30's output).
  3. Creative-testing cadence running with first contained wins shipped — by day 60.
  4. Owns blended CAC/MER (B2C) or cost-per-SQL and pipeline contribution (B2B) against validated numbers — by day 90.
  5. First scale-up or kill decision made on evidence, not gut — by day 120.
- **Competencies (4–6)**: measurement/attribution judgment · channel execution across your live channels · unit-economics fluency (CAC/payback, or pipeline/SQL cost if B2B) · creative-testing discipline · founder/board-level communication · kill-decision judgment.

### Requirements

- **Must-haves (5–7)**: owned a channel's P&L-relevant metric before (not just executed someone else's plan) · can walk a ROAS/CPA discrepancy to a root cause unprompted · comfortable presenting to a founder/board · has operated without an agency pod (in-house or solo experience) · robotics/hardware or other considered-purchase B2B experience is a plus, not a bar, if you're enterprise-facing.
- **Nice-to-haves**: B2B lead-gen experience specifically if Pinefield sells to businesses · LinkedIn Ads experience if that's a live channel.
- **Disqualifiers, stated separately**: no experience past "set up and monitor a campaign" · cites certifications instead of outcomes · cannot describe a campaign they killed.
- **Spend screen**: "manages $X/month" is a filter, never a level — pair it with the kill-decision question and an incrementality-vs-attribution probe below. An unpaired spend number is meaningless.

### Comp input (directional — flag for HR/legal before any offer)

- US performance marketer, 3–5yr: ~$87.5k median; 6–9yr: ~$100k; 10–15yr: ~$135k (Take Some Risk / Search Engine Land salary survey, April 2026, 445 respondents). In-house out-earns agency at every band.
- If hiring in France: I could not verify a reliable French performance-marketing band (APEC/Michael Page data unconfirmed) — don't anchor a French offer on the US number above; get a local recruiter figure.
...
### Question bank (build from these, don't wing it)

Spend interview minutes in this order — judgment revealed per minute asked:
...
5. **Commitment screen** (cut first if you're short on time): "5 years from now — where are you?" Predicts tenure, not performance.

Never accept "best practices" as a rationale — "it depends, here's my reasoning" is the strong answer.

### Scorecard

- Behavioral anchor per point on the scale — no bare numbers.
- Every score cites a quote or concrete example, or it doesn't count.
- You score before any debrief with your co-panelist, independently.
- Weight commercial reasoning + communication over technical recall (a labelled house convention, not a published standard: Technical 40 / Communication 30 / Commercial insight 30 is one vendor's internal weighting — adapt it, don't treat it as gospel).
- Certifications score zero in competence — they're a floor, not a signal. Don't reject over a missing one.

### Work sample

**Live screen-share account audit — using your own (real) account.** You're the rare hiring manager who can offer this cheaply: hand the candidate read access to Pinefield's actual ads account (or a redacted export if you're not ready to expose it) and have them dissect it live, 60–90 minutes, inside the interview. This is the highest-signal, lowest-cost format available and it's immune to AI-generated or tool-generated audits.

- Why not a data-table case instead: it ties with the live audit on cost, but you lose the "defeats tool-generated output" property — use it only as a fallback if no panelist (i.e., you) can grade a live audit that day.
- **Deleted by name: the paid trial.** Promote it later if this becomes a senior/creative-strategist hire, or once you have budget/approval for paid work — not now, for a first generalist hire at a startup.
- **Deleted by name: any multi-hour unpaid take-home.** The field actively selects against it — senior candidates decline rather than comply, so issuing one shrinks your pool to people with uncommitted hours. Cap everything at 60–90 minutes or pay for it.
- Build the rubric before the first candidate sits down. Include a genuinely ambiguous or underpowered data point — scoring "this isn't enough evidence to conclude X" as a top answer, not a dodge, is itself the signal you're testing for.

### Ramp plan

- **Day one access**: every ad platform account, your analytics property, tag manager/CRM, any BI layer. Don't gate this on "earning trust" — delayed access is the single most avoidable cause of a slow start.
- **Week one**: set an explicit spend-approval threshold in writing. Don't leave them guessing what they can act on.
- **Staged authority**:
  - Weeks 1–2: shadow. Observe, audit, no changes.
  - Weeks 3–6: co-sign. Suggest starting the cap around 10–15% of monthly spend (~$7–10k) per change, second signature required above it — adjust to what you're comfortable with.
  - By day 60: independent within a cap — pick a real number (e.g., half the monthly budget, ~$35k) and write it down, not a vibe.
...
## Part 2 — Your Cousin: Organic Social → Paid Ads

Routed to `advertising-career`, goal: adjacent-role entry (organic social → paid). She already sits in the highest-leverage starting position on the menu — say that to her plainly, it changes the plan.
...
3. **Only fall back to "agency junior" if neither of the above is reachable** — it's still a real path (fastest, broadest reps), just not her best one given where she's starting.
4. **Freelance-first is off the menu, not last on it** — it's a standing sales job for years before any proof exists; don't let her chase day-rate numbers before she has a track record.

**What to learn, in order** (the skill's roadmap, not a random list):

1. **Unit economics — CAC, LTV, contribution margin, payback.** Leads the list on purpose: a week of study changes how every other answer she gives gets read, at any employer. This is the single highest-leverage thing she can do before touching a platform UI.
2. **Creative strategy and testing.** This is her actual unfair advantage — it's the appreciating skill in the field (practitioner consensus: no AI replacement yet) and it's exactly what organic social already trained her to do. Position this as her wedge in interviews, not a gap to fill.
3. **Technical measurement basics** (server-side tracking, conversions APIs, consent mode) — mid-to-senior skill, but worth a working vocabulary now so she isn't blindsided later.
4. Everything after that (forecasting, cross-channel allocation, incrementality) is senior-track and not worth her time yet — don't let her over-invest in certifications or advanced material before she has reps.
