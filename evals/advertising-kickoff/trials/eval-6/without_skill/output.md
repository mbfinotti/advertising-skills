...
Industry numbers only matter relative to what *you* can afford to pay. Compute this first:
...
I don't have live data access this session, so treat these as **directional industry ballparks**, not sourced facts — validate against RevenueCat's *State of Subscription Apps* report and each platform's own benchmark tool once you have real spend data.
...
3. Every channel must report to the *same* two numbers: cost, and paid conversions. If a channel can't give you that cleanly, don't fund it yet.
