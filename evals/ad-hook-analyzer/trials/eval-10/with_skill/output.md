...
4. **Don't ask me for a hook-rate number before launch.** Ask me to compare this cell's _measured_ hook rate against your account's own future batches once you have a dashboard definition locked (`3-second plays ÷ impressions` is Meta's standard construction — confirm that's what you're reading). That comparison is the thing this method can actually do.
