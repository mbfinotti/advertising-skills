...
**6. Your ABM "900 accounts" is a company list, not a people list.** Uploaded as a Matched Audience, LinkedIn will serve to *everyone* at those 900 companies unless you also stack job-title/seniority filters on top. Without that, your demo-request CTA reaches SDRs, interns, and unrelated departments — wasted spend and a bad look ("Request a Demo" ad hitting someone who can't buy). Layer the same 5-role title/seniority filter onto the ABM list.
...
| VP Sales / CRO *(assumed)* | $1,400 | ~2,500 | Exec-level soft ask |
| CFO / VP Finance *(assumed)* | $600 | ~1,000 | Benchmark report (no demo CTA) |
...
- **Headline**: *"Your forecast is only as good as your CRM data. Fix the data, fix the forecast."*
...
- **Headline**: *"Stop guessing what your top reps say. See it, coach it, scale it."*
...
### VP Sales / CRO *(assumed — confirm this is your 4th role)*
...
- **Headline**: *"Know which deals are slipping before your reps do."*
...
### CFO / VP Finance *(assumed — confirm this is your 5th role, and see note above on weak paid-social fit)*
...
- **Headline**: *"Plan the business on a forecast you can actually trust."*
...
- **Creative 1 (lead, weeks 1–2)**: Peer proof point — *"See how [mid-market segment] revenue teams cut forecast variance by [X]%"* — case-study format, no hard CTA.
- **Creative 2 (retarget after 1+ impression, weeks 2+)**: *"You already know Loopwell — let's show you what it does for [pipeline/forecast accuracy/ramp time] specifically."* → Request a Demo.
