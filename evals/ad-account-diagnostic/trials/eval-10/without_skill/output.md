...
- A new consent banner commonly changes default state, CMP vendor, or the conditions under which the pixel/Conversions API fires. That silently drops *recorded* conversions while real ones may be untouched — CPA rises on paper with nothing wrong in the account.
...
4. CRM access matters most as a *tie-breaker* between "conversions are genuinely down" vs "conversions are fine, just invisible" — worth escalating past "maybe next month" once you have the consent-rate evidence in hand, since that evidence is what will make the case.