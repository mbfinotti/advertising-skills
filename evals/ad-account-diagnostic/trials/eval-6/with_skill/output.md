...
4. **Only after that**, rank campaigns by their own platform-native metric against their own history (CPA or ROAS trend within Meta, within Google, within GA4-sourced channels) — never mixed, never against industry benchmarks — and then cut the bottom 20% of *that* clean ranking, if a real decline survives.
