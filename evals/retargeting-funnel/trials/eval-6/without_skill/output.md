# Lanternway Outfitters — Q4 Paid Media Split

## The math the board didn't run

Retargeting can't absorb a 50% share of $48k/month. The audience is too small.

- Pool: 8,000 people
- Frequency cap: 6 impressions/week
- Max weekly impressions: 8,000 × 6 = 48,000
- Max monthly impressions: 48,000 × 4.3 weeks ≈ 206,000
- Max monthly spend at $16 CPM: **≈ $3,300/month (~7% of budget)**

Above that, dollars don't convert to more impressions — they either break the frequency cap (fatigue, falling ROAS) or sit unspent while CPM gets bid up chasing the same 8,000 people.
...
Get the platform's actual frequency distribution before the board meeting. If it's really running at 22/week, the 11x number is suspect and shouldn't be the sole justification for shifting more budget its way.

## Why literal 50/50 is the wrong instrument, not the wrong instinct
...
- Run a holdout/geo incrementality test on retargeting for 2-3 weeks. Platform-reported 11x almost certainly overstates true lift; you want a real number before committing a quarter's budget to the story.
- Track pool size weekly as you build out warm expansion — if the CRM/extended-window audiences don't scale past ~30-40k people, the same ceiling math will cap that bucket too, and you'll need to revisit.
- Watch CPM on the core retargeting line for creep as competition inside the fixed 8,000-person pool increases — even at $3,300, don't assume that ceiling is stable if creative fatigue sets in.
- Re-cut prospecting by segment performance, not an across-the-board haircut — some slices of that 1.9x blend are almost certainly funding the retargeting pool's future inventory.
