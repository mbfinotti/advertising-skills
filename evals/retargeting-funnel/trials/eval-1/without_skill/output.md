...
- Messaging: dynamic ads of the _exact_ scent viewed, notes/ingredients, reviews for that SKU, "still deciding?" framing. Nudge with free-shipping threshold rather than a % discount — reserve real discounts for higher-funnel stages.
