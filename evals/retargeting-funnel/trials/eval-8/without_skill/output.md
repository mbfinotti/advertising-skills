...
- **Reverse causality / endogeneity**: spend is usually set _in response to_ expected or observed demand (you spend more in weeks you expect to convert well), so the correlation runs both ways.
