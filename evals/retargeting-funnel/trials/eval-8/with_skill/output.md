...
- **Pre-registered decision rule, agreed with the CFO _before_ the test starts:** if the holdout group's signup rate is statistically indistinguishable from the exposed group's, retargeting spend is cut or folded back into prospecting — regardless of what the platform ROAS says. Getting her sign-off on this rule in advance is what converts the exercise from "marketing grading its own homework" into something she'll trust.
