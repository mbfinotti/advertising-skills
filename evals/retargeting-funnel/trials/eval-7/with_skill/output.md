...
| Consumables (beans, filters)             | ~60 days (= your reorder cycle) | The item _should_ reappear once the reorder cycle completes — but as a **refill/cross-sell offer**, not a "new purchase" dynamic ad |
